...
red_wine_path = os.environ["WINEQUALITY_RED_PATH"]
white_whine_path = os.environ["WINEQUALITY_WHITE_PATH"]
...
white_wine = pd.read_csv(white_whine_path, sep=';')
...
table_path = f"dbfs:/{username}/delta/wine_data"
